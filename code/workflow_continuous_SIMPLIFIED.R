...
# Aggressively simplify the landscape
current_raster[current_raster >= 0.5] <- 2
current_raster[current_raster < 0.5] <- 1
...
# 
# 
# sample_points_output_variables <- c("raster_id", "aoi_id", "frame_id", "tpoly_id", "sample_id", "sample_seed", "value", "weight")
