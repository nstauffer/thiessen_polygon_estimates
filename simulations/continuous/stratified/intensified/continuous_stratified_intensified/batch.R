# Continuous, stratified, unstratified intensification
...
sim_file <- "C:/Users/Nelson/Documents/Projects/thiessen_polygon_estimates/code/workflow_continuous_stratified_intensified.R"
...
output_path <- paste0("C:/Users/Nelson/Documents/Projects/thiessen_polygon_estimates/simulations/",
                      ...
                      "stratified/",
                      "intensified/",
                      "continuous_stratified_intensified",
                      "/output/")
...
int_n_vertices <- 6
int_convex_hull <- TRUE
sample_type <- "simple"
n_aoi_sample_points <- 15
