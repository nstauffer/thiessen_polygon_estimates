...
output_path <- "C:/Users/Nelson/Documents/Projects/thiessen_polygon_estimates/simulations/intensification_categorical_decreasedthiessen/output/"
# simulation_seed <- 1
...
# Clip the frame to the AOI
frame <- sf::st_intersection(x = frame,
                            y = aoi)[, c("aoi_id", "aoi_seed")]
